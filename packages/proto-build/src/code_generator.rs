...
pub struct CodeGenerator {
    project: FinschiaProject,
    root: PathBuf,
    out_dir: PathBuf,
    tmp_build_dir: PathBuf,
    deps: Vec<FinschiaProject>,
}
...
impl CodeGenerator {
    ...
    fn prepare_dir(&self) {
        ...
        output_version_file(&self.project.version, &self.tmp_namespaced_dir());
    }
...
fn output_version_file(versions: &str, out_dir: &Path) {
    let path = out_dir.join("FINSCHIA_SDK_COMMIT");
